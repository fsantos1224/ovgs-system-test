...
O sistema deverá permitir o cadastro de diferentes modalidades de transporte.
...
O sistema deverá suportar os seguintes estados:
...
A solução deverá registrar eventos relevantes para fins de rastreabilidade.
...
Os testes deverão contemplar cenários relevantes das regras de negócio.

Será considerado diferencial apresentar estratégia mais abrangente de cobertura.
...
## O Que Esperamos de um Desenvolvedor Sênior

Durante a avaliação serão observados aspectos que vão além da implementação funcional:
