  ...
  const sidebarContent = (inDrawer = false) => (
    <>
      ...
      <div className="p-4 border-b border-border flex items-center justify-between gap-2 shrink-0">
        <div className={`flex flex-col leading-tight ${inDrawer || sidebarOpen ? '' : 'hidden'}`}>
          <span className="text-[9px] tracking-[0.3em] font-bold uppercase text-text-faint">XPTO</span>
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        <header className="lg:hidden sticky top-0 z-30 bg-canvas/80 backdrop-blur-md border-b border-border shrink-0">
          <div className="flex items-center justify-between h-14 px-3">
            ...
            <span className="text-[11px] font-bold uppercase tracking-[0.2em] text-text">{currentPageTitle}</span>
        ...
        {/* Page content */}
        <main id="main-content" className="flex-1 overflow-auto p-4 lg:p-8 bg-canvas" role="main" tabIndex={-1}>
          <Outlet />
        </main>
      </div>
      <Toaster />
