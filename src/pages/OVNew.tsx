...
import { ovFormSchema, type ItemOV } from '../schemas';
...
export function OVNew() {
  ...
  if (transporteSelecionadoId && clienteSelecionado && !canUseTransporte(clienteSelecionado, transporteSelecionadoId)) {
    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="border-b border-border pb-6">
        ...
        <p className="mt-1.5 text-xs text-text-muted tracking-wide font-medium">
          Cadastre uma nova ordem de venda no sistema.
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="max-w-4xl space-y-6">
        <div className="bg-surface rounded-xl border border-border p-6 space-y-5 shadow-2xl">
          ...
          <div className="space-y-1.5">
            <label className="text-[10px] font-bold text-text-faint uppercase tracking-widest block">
              Transporte <span className="text-amber-500">*</span>
            </label>
            <select
          ...
          <div className="space-y-1.5">
            <label className="text-[10px] font-bold text-text-faint uppercase tracking-widest block">
              Data de Entrega Prevista <span className="text-amber-500">*</span>
            </label>
            <input
              type="date"
            ...
            {fieldErrors.dataEntregaPrevista && (
              <p role="alert" className="text-rose-400 text-xs mt-1">
                {fieldErrors.dataEntregaPrevista.message}
              </p>
            )}
          </div>
